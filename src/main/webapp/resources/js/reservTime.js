...
$(function () {
    ...
    $("#datepicker").datepicker({
        ...
        onSelect: function () {
            ...
            if(selectedDate.substring(1,2) == ".") selectedDate = "0"+selectedDate;
            if(selectedDate.substring(5,6) == ".") selectedDate = selectedDate.substring(0,4)+"0"+selectedDate.substring(4);
